...
import React__default, { useLayoutEffect, forwardRef, useContext, createElement, createContext, Fragment, useRef, Children, isValidElement, cloneElement, useDebugValue, useEffect, useMemo } from 'react';
...
const Grid = /*#__PURE__*/React.forwardRef(function Grid(inProps, ref) {
  ...
  const columnsContext = React.useContext(GridContext$1); // columns set with default breakpoint unit of 12
...
function ItemList(props) {
    ...
    return (jsx(Paper$1, { children: jsx(Grid$1, __assign({ container: true, spacing: 6, sx: { overflow: "auto", height: "80vh", marginTop: "3em" } }, { children: items.map(function (item) { return (jsx(Grid$1, __assign({ item: true, xs: 12, md: 6, lg: 3 }, { children: jsx(Stack$1, __assign({ onClick: function () { return HandleClick(item); }, direction: "column", alignItems: "center", justifyContent: "center", sx: {
                        width: "300px",
                        height: "100%",
                        rowGap: "1em",
                        cursor: "pointer"
                    }, component: Paper$1 }, { children: headers.map(function (headerItems) {
                        return (jsx("div", __assign({ className: headerItems["className"] }, { children: headerItems.hasImage ? (headerItems.imageComponent(safeAccess(item, ["".concat(headerItems["accessor"])]))) : headerItems.nestedObj ? (jsx(Typography$1, __assign({ variant: "h6", component: "h6", sx: { fontSize: "16px" } }, { children: jsxs("span", __assign({ className: "flex gap-[0.5em]" }, { children: [headerItems["withIcons"] && headerItems["withIcons"], safeAccess(item, headerItems["accessor"])] })) }))) : (jsxs(Typography$1, __assign({ variant: "h6", component: "h6", sx: { fontSize: "16px" }, className: headerItems["className"] }, { children: [headerItems["htmlSign"] && headerItems["htmlSign"], safeAccess(item, ["".concat(headerItems["accessor"])])] }))) }), "".concat(headerItems["accessor"])));
...
function MediaCard(props) {
    ...
    return (jsxs(Card$1, __assign({ className: "text-ellipsis", sx: {
            width: 400,
            height: "auto",
            padding: "1em",
            display: "flex",
            flexWrap: "wrap"
        } }, { children: [jsx(default_1$5, { onClick: handleCloseItem, sx: {
                    position: "absolute",
                    right: 0,
                    top: 0,
                    color: "red",
                    cursor: "pointer"
                } }), jsx("span", __assign({ className: "align-center flex w-screen justify-center" }, { children: jsx("img", { style: {
                        width: "200px",
                        objectFit: "cover",
                        cursor: "pointer"
                    }, src: "".concat(safeAccess(item, ["image"]), "?w=8&h=8&fit=crop&auto=format"), srcSet: "".concat(safeAccess(item, [
                        "image"
                    ]), "?w=8&h=8&fit=crop&auto=format&dpr=2"), alt: "".concat(safeAccess(item, ["title"])), loading: "lazy" }) })), jsxs(CardContent$1, __assign({ className: "align-center flex flex-col justify-between gap-[0.5em]" }, { children: [jsx(Typography$1, __assign({ gutterBottom: true, variant: "h5", component: "div" }, { children: safeAccess(item, ["title"]) })), jsx(Typography$1, __assign({ gutterBottom: true, variant: "h6", component: "div", sx: { overflow: "auto", fontSize: "16px", height: "100px" } }, { children: safeAccess(item, ["description"]) })), jsxs("span", { children: [jsx(default_1$4, {}), safeAccess(item, ["rating", "rate"])] }), jsxs("span", __assign({ className: "ml-2" }, { children: ["\u20B1", safeAccess(item, ["price"])] }))] })), jsxs(CardActions$1, __assign({ className: "gap-[2em] text-center" }, { children: [jsx(Button$1, __assign({ onClick: function () { return handleCheckoutCart(item); }, variant: "contained", sx: { fontWeight: "900", backgroundColor: "#14C38E" } }, { children: "CHECKOUT" })), jsx(Button$1, __assign({ onClick: function () { return handleAddTuCart(item); }, variant: "contained", sx: { fontWeight: "900", backgroundColor: "#FF5B00" } }, { children: "ADD TO CART" }))] }))] })));
}

var DialogBox = function (props) {
    var open = props.open, children = props.children;
    return (jsx(Dialog$1, __assign({ open: open, className: "h-auto w-auto" }, { children: React__default.Children.map(children, function (child) {
...
var mainWindow = function (_a) {
    ...
    return (jsxs(Fragment$1, { children: [jsx(Box$1, __assign({ sx: {
                    width: "100%",
                    height: "auto"
                } }, { children: jsx(ItemList, { headers: headers, items: items, onClickValue: handleViewItemCLick }) })), jsx(DialogBox, __assign({ open: openCardItems }, { children: jsx(MediaCard, { item: cardItems, handleCloseItem: handleCloseItem, handleAddTuCart: handleAddTuCart, handleCheckoutCart: handleCheckoutCart }) }))] }));
};
...
var CartCounts = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "relative" }, { children: [jsx(default_1$3, { fontSize: "large", sx: { cursor: "pointer" }, onClick: function () { return handleOpenCart(true); } }), jsx("h1", __assign({ className: "absolute top-0 right-0 mr-10 min-w-0 font-extrabold text-blue-600" }, { children: itemCounts }))] })));
};
...
var AddedToCart = function (_a) {
    ...
    return (jsx(Box$1, __assign({ sx: { width: "100%", height: "100%" } }, { children: jsxs(Fragment$1, { children: [jsxs(Stack$1, __assign({ direction: "row", alignItems: "center", justifyContent: "space-between" }, { children: [jsx("h1", __assign({ className: "ml-4 font-black" }, { children: "CART ITEMS" })), jsx(default_1$5, { onClick: function () { return handleCloseAddToCart(false); }, sx: {
                                float: "right",
                                color: "red",
                                margin: "0.5em",
                                cursor: "pointer"
                            } })] })), jsx(TableContainer$1, __assign({ component: Paper$1, sx: { height: "400px", width: "100%", overflow: "auto" } }, { children: jsxs(Table$1, __assign({ size: "small", "aria-label": "a dense table", sx: { position: "relative" } }, { children: [jsx(TableHead$1, __assign({ sx: {
                                    position: "sticky",
                                    top: 0,
                                    zIndex: 1,
                                    backgroundColor: "white"
                                } }, { children: jsx(TableRow$1, __assign({ sx: { fontWeight: 1000 } }, { children: headers === null || headers === void 0 ? void 0 : headers.map(function (items) {
                                        console.log('safeAccess(items, ["sx"])', safeAccess(items, ["sx"]));
                                        return (jsx(TableCell$1, __assign({ align: "left", sx: safeAccess(items, ["sx"]) ? safeAccess(items, ["sx"]) : null }, { children: items["header"] }), "".concat(safeAccess(items, ["accessor"]), " ").concat(Math.random())));
                                    }) })) })), cartItemList.length > 0 ? (jsx(TableBody$1, { children: jsx(Fragment$1, { children: cartItemList.map(function (bodyItem) {
                                        return (jsx(TableRow$1, __assign({ className: "mb-10", sx: {
                                                "&:last-child td, &:last-child th": { border: 0 }
                                            } }, { children: headers === null || headers === void 0 ? void 0 : headers.map(function (headerItems, id) {
                                                return (jsx(TableCell$1, { children: headerItems.withComputation ? (cartItemList
                                                        .reduce(function (sum, acc) {
                                                        return (sum +
                                                            safeAccess(acc, ["price"]) *
                                                                safeAccess(acc, ["quantity"]));
                                                    }, 0)
                                                        .toFixed(2)) : headerItems.hasComponent ? (jsxs(Stack$1, __assign({ direction: "row", alignItems: "center", sx: { gap: "1em" } }, { children: [jsx(default_1$2, { onClick: function () {
                                                                    ...
                                                                    cursor: "pointer",
                                                                    "&:hover": { opacity: 0.1 }
                                                                } }), jsx("span", { children: safeAccess(bodyItem, [
                                                                    "".concat(headerItems["accessor"])
                                                                ]) }), jsx(default_1$1, { onClick: function () {
                                                        ...
                                                        "".concat(headerItems["accessor"])
                                                    ]))) : headerItems["accessor"] === "cancelIcon" ? (jsx(default_1, { sx: { cursor: "pointer", color: "red" }, onClick: function () {
                                                            return handleRemoveCartItems(safeAccess(bodyItem, ["".concat(headerItems["id"])]));
                                                        } })) : (safeAccess(bodyItem, ["".concat(headerItems["accessor"])])) }, id));
                                            }) })));
                                    }) }) })) : (jsx("h1", __assign({ className: "absolute bottom-[-1] left-0 translate-y-[650%] translate-x-[340%]" }, { children: "NO ITEMS" })))] })) }))] }) })));
};
...
var Checkout = function (_a) {
    ...
    return (jsxs(Grid$1, __assign({ container: true, sx: { marginTop: "1em", marginBottom: "1em", rowGap: "1em" } }, { children: [jsx(Divider$1, {}), jsxs(Grid$1, __assign({ item: true, xs: 12, md: 12, sx: {
                    display: "flex",
                    justifyContent: "center",
                    gap: "10em"
                } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "Subtotal" })), jsxs("span", { children: [" \u20B1", subTotal] })] })), jsx(Divider$1, {}), jsxs(Grid$1, __assign({ item: true, xs: 12, md: 12, sx: { display: "flex", justifyContent: "center", gap: "10em" } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "Shipping" })), jsxs("span", { children: [" \u20B1", shippingFee] })] })), jsx(Divider$1, {}), jsxs(Grid$1, __assign({ item: true, xs: 12, md: 12, sx: {
                    display: "flex",
                    justifyContent: "center",
                    gap: "10em",
                    marginTop: "2em"
                } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "TOTAL" })), jsxs("span", { children: ["\u20B1", total] })] })), jsx(Button$1, __assign({ onClick: function () { return itemCounts && handleCheckoutExit(true); }, sx: {
                    width: "100%",
                    color: "white",
                    fontWeight: 900,
...
var CartItems = function (props) {
    ...
    return (jsxs(Fragment$1, { children: [jsx(CartCounts, { itemCounts: itemCounts, handleOpenCart: handleOpenCart }), jsxs(DialogBox, __assign({ open: open }, { children: [jsx(AddedToCart, { headers: headers, cartItemList: cartItems, handleQuantity: handleQuantity, handleCloseAddToCart: handleOpenCart, handleRemoveCartItems: handleRemoveCartItems }), jsx(Checkout, { itemCounts: itemCounts, subTotal: subTotal, shippingFee: shippingFee, total: total, handleCheckoutExit: handleCheckoutExit })] })), snackBarMessage(checkout)] }));
};
...
var ListItemsViewModel = function (dataLoad) {
    ...
    var handleViewItemCLick = React.useCallback(function (item) {
        dispatch(setViewItemDetails(item));
    }, []);
    var handleCloseItem = React.useCallback(function (e) {
        dispatch(setViewItemDetails({}));
    }, []);
    var handleAddTuCart = React.useCallback(function (item) {
        dispatch(setAddTuCartItems(item));
    }, []);
    var handleCheckoutCart = React.useCallback(function (item) {
        dispatch(setAddTuCartItems(item));
        dispatch(setViewItemDetails({}));
...
var ViewModel = function () {
    var ItemsSelector = useAppSelector(shopSelector, shallowEqual);
    var dispatch = useAppDispatch();
    var _a = React.useState(false), checkout = _a[0], setCheckout = _a[1];
    var removeItemDuplicates = React.useMemo(function () { return RemoveDuplicate(safeAccess(ItemsSelector, ["addCartItems"])); }, [safeAccess(ItemsSelector, ["addCartItems"])]);
    var handleOpenCart = React.useCallback(function (data) {
        dispatch(setViewCartItems(data));
    }, []);
    var handleQuantity = React.useCallback(function (data, id) {
        dispatch(setHandleQuantity({ data: data, id: id }));
    }, []);
    var handleRemoveCartItems = React.useCallback(function (data) {
        dispatch(setRemoveCartItems(data));
    }, []);
    var computeSubtotal = React.useMemo(function () {
        return removeItemDuplicates.reduce(function (sum, val) {
            return sum + val["quantity"] * val["price"];
        }, 0);
    }, [removeItemDuplicates]);
    var computeShippingFee = React.useMemo(function () { return computeSubtotal * (50 / 100); }, [computeSubtotal]);
    var computeTotalValue = React.useMemo(function () { return computeSubtotal + computeShippingFee; }, [computeSubtotal, computeShippingFee]);
    var handleCheckoutExit = React.useCallback(function (data) {
...
var ShoppingCartIndex = function (props) {
    ...
    return (jsxs(React.Fragment, { children: [jsx(CssBaseline, {}), jsx(Container$1, __assign({ maxWidth: false }, { children: jsx(Box$1, __assign({ sx: { bgcolor: "white", height: "100vh", flexGrow: 1 } }, { children: jsxs(Grid$1, __assign({ container: true }, { children: [jsxs(Grid$1, __assign({ container: true, direction: "row", justifyContent: "space-around", id: "title header", className: "mt-5" }, { children: [jsx(Grid$1, __assign({ item: true, xs: 8 }, { children: "SIMPLE SHOPPING CART" })), jsx(Grid$1, __assign({ item: true, xs: 4, className: "flex justify-end" }, { children: jsx(CartItems, { open: safeAccess(cartItemsSelector, ["viewCartOpen"]), itemCounts: itemCounts, headers: safeAccess(dataIn, ["addToCartHeader"]), snackBarMessage: safeAccess(dataOut, ["snackBarMessage"]), handleOpenCart: handleOpenCart, cartItems: cartItems, handleQuantity: handleQuantity, handleRemoveCartItems: handleRemoveCartItems, subTotal: subTotal, shippingFee: shippingFee, total: total, handleCheckoutExit: handleCheckoutExit, checkout: checkout }) }))] })), jsxs(Grid$1, __assign({ item: true, xs: 12, id: "list-items-box" }, { children: [jsx(mainWindow, { cardItems: safeAccess(ItemsSelector, ["viewItem"]), handleCloseItem: handleCloseItem, handleAddTuCart: handleAddTuCart, handleCheckoutCart: handleCheckoutCart, handleViewItemCLick: handleViewItemCLick, items: safeAccess(ItemsSelector, ["items"]), openCardItems: safeAccess(ItemsSelector, ["viewItem", "isOpen"]), headers: safeAccess(dataIn, ["itemListHeader"]) }), dataOut === null || dataOut === void 0 ? void 0 : dataOut.addToCartSnackBarMessage(safeAccess(ItemsSelector, ["addCartMessage", "open"]), safeAccess(ItemsSelector, ["addCartMessage", "message"]), handleAddTuCart)] }))] })) })) }))] }));
};

var ShoppingCart = function (_a) {
    var dataIn = _a.dataIn, dataLoad = _a.dataLoad, dataOut = _a.dataOut;
    return (jsx(Provider, __assign({ store: store }, { children: jsx(ShoppingCartIndex, { dataLoad: dataLoad, dataIn: dataIn, dataOut: dataOut }) })));
};
