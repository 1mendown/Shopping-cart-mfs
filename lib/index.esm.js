...
import React__default, { Children, isValidElement, cloneElement, createContext, useContext, useDebugValue, useLayoutEffect, useEffect, useMemo } from 'react';
import { Paper as Paper$2, Grid as Grid$2, Stack as Stack$2, Typography as Typography$2, Divider, Button as Button$2 } from '@mui/material';
...
function ItemList(props) {
    ...
    return (jsx(Paper$2, { children: jsx(Grid$2, __assign({ container: true, spacing: 6, sx: { overflow: "auto", height: "80vh", marginTop: "3em" } }, { children: items.map(function (item) { return (jsx(Grid$2, __assign({ item: true, xs: 12, md: 6, lg: 3 }, { children: jsx(Stack$2, __assign({ onClick: function () { return HandleClick(item); }, direction: "column", alignItems: "center", justifyContent: "center", sx: {
                        width: "300px",
                        height: "100%",
                        rowGap: "1em",
                        cursor: "pointer"
                    }, component: Paper$2 }, { children: headers.map(function (headerItems) {
                        return (jsx("div", __assign({ className: headerItems["className"] }, { children: headerItems.hasImage ? (headerItems.imageComponent(safeAccess(item, ["".concat(headerItems["accessor"])]))) : headerItems.nestedObj ? (jsx(Typography$2, __assign({ variant: "h6", component: "h6", sx: { fontSize: "16px" } }, { children: jsxs("span", __assign({ className: "flex gap-[0.5em]" }, { children: [headerItems["withIcons"] && headerItems["withIcons"], safeAccess(item, headerItems["accessor"])] })) }))) : (jsxs(Typography$2, __assign({ variant: "h6", component: "h6", sx: { fontSize: "16px" }, className: headerItems["className"] }, { children: [headerItems["htmlSign"] && headerItems["htmlSign"], safeAccess(item, ["".concat(headerItems["accessor"])])] }))) }), "".concat(headerItems["accessor"])));
...
var mainWindow = function (_a) {
    ...
    return (jsxs(Fragment, { children: [jsx(Box$1, __assign({ sx: {
                    width: "100%",
                    height: "auto"
...
var AddedToCart = function (_a) {
    ...
    return (jsx(Box$1, __assign({ sx: { width: "100%", height: "100%" } }, { children: jsxs(Fragment, { children: [jsxs(Stack$1, __assign({ direction: "row", alignItems: "center", justifyContent: "space-between" }, { children: [jsx("h1", __assign({ className: "ml-4 font-black" }, { children: "CART ITEMS" })), jsx(default_1$5, { onClick: function () { return handleCloseAddToCart(false); }, sx: {
                                ...
                                cursor: "pointer"
                                    ...
                                    }) })) })), cartItemList.length > 0 ? (jsx(TableBody$1, { children: jsx(Fragment, { children: cartItemList.map(function (bodyItem) {
...
var Checkout = function (_a) {
    ...
    return (jsxs(Grid$2, __assign({ container: true, sx: { marginTop: "1em", marginBottom: "1em", rowGap: "1em" } }, { children: [jsx(Divider, {}), jsxs(Grid$2, __assign({ item: true, xs: 12, md: 12, sx: {
                    display: "flex",
                    justifyContent: "center",
                    gap: "10em"
                } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "Subtotal" })), jsxs("span", { children: [" \u20B1", subTotal] })] })), jsx(Divider, {}), jsxs(Grid$2, __assign({ item: true, xs: 12, md: 12, sx: { display: "flex", justifyContent: "center", gap: "10em" } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "Shipping" })), jsxs("span", { children: [" \u20B1", shippingFee] })] })), jsx(Divider, {}), jsxs(Grid$2, __assign({ item: true, xs: 12, md: 12, sx: {
                    display: "flex",
                    justifyContent: "center",
                    gap: "10em",
                    marginTop: "2em"
                } }, { children: [jsx("span", __assign({ className: "font-bold" }, { children: "TOTAL" })), jsxs("span", { children: ["\u20B1", total] })] })), jsx(Button$2, __assign({ onClick: function () { return itemCounts && handleCheckoutExit(true); }, sx: {
                    width: "100%",
                    color: "white",
                    fontWeight: 900,
...
var CartItems = function (props) {
    ...
    return (jsxs(Fragment, { children: [jsx(CartCounts, { itemCounts: itemCounts, handleOpenCart: handleOpenCart }), jsxs(DialogBox, __assign({ open: open }, { children: [jsx(AddedToCart, { headers: headers, cartItemList: cartItems, handleQuantity: handleQuantity, handleCloseAddToCart: handleOpenCart, handleRemoveCartItems: handleRemoveCartItems }), jsx(Checkout, { itemCounts: itemCounts, subTotal: subTotal, shippingFee: shippingFee, total: total, handleCheckoutExit: handleCheckoutExit })] })), snackBarMessage(checkout)] }));
};
